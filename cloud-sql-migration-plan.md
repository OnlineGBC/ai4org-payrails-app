...
gcloud run deploy payrails \
  ...
  --set-env-vars "SEED_DATA=true,DATABASE_URL=postgresql+psycopg2://payrails-user:PayRails2026Secure@/payrails?host=/cloudsql/fednowrtppayrails:us-east1:payrails-db" \
  --project=fednowrtppayrails
```
...
| DB Password | PayRails2026Secure |
